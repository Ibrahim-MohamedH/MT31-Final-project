  ...
  <ul class="sidebar-nav" id="sidebar-nav">
    ...
    <li class="nav-item">
      ...
      <ul
        ...
        <li>
          <a href="<?= dashboradURL('properties/list.php') ?>">
    ...
    <li class="nav-item">
      ...
      <ul
        ...
        data-bs-parent="#sidebar-nav">
        <li>
          <a href="<?= dashboradURL('services/list.php') ?>">
    ...
    <li class="nav-item">
      ...
      <ul
        ...
        data-bs-parent="#sidebar-nav">
        <li>
          <a href="<?= dashboradURL('agents/list.php') ?>">
    ...
    <li class="nav-item">
      ...
      <ul
        ...
        data-bs-parent="#sidebar-nav">
        <li>
          <a href="<?= dashboradURL('messages/list.php') ?>">
    ...
    <li class="nav-item">
      <a class="nav-link collapsed" href="<?= dashboradURL('users-profile.php') ?>">
